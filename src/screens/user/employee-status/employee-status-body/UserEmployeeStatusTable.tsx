    ...
    return (
        <div className='relative w-xl p-2 m-4 border border-border bg-primary-foreground min-h-[130px]'>
            <div className='flex p-4 justify-between items-center bg-primary mb-2'>
                <p className='text-white '>MY ACTIVITIES</p>
            ...
            <div className='flex items-center w-full content-center py-2'>
                ...
                <Button title='Add Activity' onClick={() => setIsAddActivityDialogOpen(true)} className='ml-2 justify-end text-white flex gap-2'>Add Activity <PlusSquareIcon className=' w-4 h-4' /></Button>
            </div>
            ...
            <div className="flex gap-2 py-2">
                ...
                <button
                    onClick={() => setFilterType('Work from Home')}
                    className={`p-2 border border-border text-primary rounded ${filterType === 'Work from Home' ? 'bg-blue-500 text-white' : ''}`}
                >
                    Work from Home
                </button>
                <button
                    onClick={() => setFilterType('Holiday')}
                    className={`p-2 border border-border text-primary rounded ${filterType === 'Holiday' ? 'bg-blue-500 text-white' : ''}`}
                >
                    Holiday
                </button>
                <button
                    onClick={() => setFilterType('Off Set')}
                    className={`p-2 border border-border text-primary rounded ${filterType === 'Off Set' ? 'bg-blue-500 text-white' : ''}`}
                >
                    Off Set
                </button>
            </div>
                ...
                <Table>
                    <TableHeader>
                        <TableRow>
                            ...
                            <TableHead className='text-white border border-border text-md sticky top-0 bg-primary'>STATUS</TableHead>
