import{r as i,u as A,s as o,j as e,T as _,M as C,a as j,L as E}from"./index-2cfb09e7.js";import{R as z,L as D}from"./login-26b670a0.js";import{I as k}from"./InputText-b353a206.js";import{S as m}from"./sweetalert2.esm.all-3fe0d2e9.js";import{E as P,a as F}from"./eye-46d22c26.js";import{L as R}from"./loader-2-e0555315.js";import"./input-63fb76d9.js";const $="/regional/assets/DICT-Logo-Login-75c06a4b.webp";function H(){const[c,N]=i.useState(!1),[g,b]=i.useState(!1),[d,f]=i.useState(0),[n,u]=i.useState(!1),[l,x]=i.useState(null),h=A(),[r,T]=i.useState({email:"",password:""}),w=r.email.trim()!==""&&r.password.trim()!=="",p=5,v=15*60*1e3;i.useEffect(()=>{o.getItem("accessToken")&&h("/regional/user/home");const t=o.getItem("lockoutTime"),a=o.getItem("failedAttempts");if(t){const s=new Date(t);new Date().getTime()-s.getTime()<v?(u(!0),x(s),f(parseInt(a||"0"))):(o.removeItem("lockoutTime"),o.removeItem("failedAttempts"))}},[]),i.useEffect(()=>{let t;return n&&l&&(t=setInterval(()=>{new Date().getTime()-l.getTime()>=v&&(u(!1),x(null),f(0),o.removeItem("lockoutTime"),o.removeItem("failedAttempts"),clearInterval(t))},1e3)),()=>{t&&clearInterval(t)}},[n,l]);const y=()=>{if(!l)return 0;const a=new Date().getTime()-l.getTime(),s=Math.max(0,v-a);return Math.ceil(s/1e3/60)},S=()=>{const t=d+1;if(f(t),o.setItem("failedAttempts",t.toString()),t>=p){const a=new Date;u(!0),x(a),o.setItem("lockoutTime",a.toISOString()),m.fire({icon:"warning",title:"Too Many Failed Attempts! 🚫",html:`
                ...
                `,confirmButtonText:"Try Again",confirmButtonColor:"#ef4444"})}},L=()=>{f(0),o.removeItem("failedAttempts"),o.removeItem("lockoutTime")};return e.jsx(_,{defaultTheme:"light",storageKey:"vite-ui-theme",children:e.jsxs("div",{className:"bg-background relative w-screen h-screen overflow-hidden flex justify-center",children:[e.jsx("div",{className:"absolute right-0 p-10 z-30",children:e.jsx(C,{})}),e.jsxs("div",{className:"relative w-full h-full flex flex-col gap-4 items-center justify-center",children:[e.jsx("img",{src:z,className:"pointer-events-none absolute z-0 h-full w-full object-cover opacity-5",alt:""}),e.jsxs("div",{className:"flex gap-3 items-center",children:[e.jsx("img",{src:D,className:"animate__animated animate__slideInLeft h-16 object-contain",alt:""}),e.jsx("a",{href:"https://www.facebook.com/DICTRegion10",target:"_blank",children:e.jsx("img",{src:$,className:"animate__animated animate__slideInRight h-24 object-contain",alt:""})})]}),e.jsxs("form",{className:"animate__animated animate__fadeInUp mb-10 z-10 w-full sm:w-[95%] sm:mx-4 max-w-[450px] flex flex-col items-center min-h-[100px] py-10 px-6 rounded-md bg-card border-2 border-border",onSubmit:t=>{if(t.preventDefault(),n){m.fire({icon:"warning",title:"Account Temporarily Locked 🔒",html:`
                                    <div style="text-align: center; margin: 20px 0;">
                                        <p style="font-size: 16px; margin-bottom: 15px;">
