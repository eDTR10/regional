      ...
      <div className="flex-1 flex flex-col items-center justify-center min-h-screen p-6">
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="relative flex items-center justify-center">
              ...
              <div className="absolute w-[350px] h-[350px] sm:w-[240px] sm:h-[240px] pointer-events-none rounded-full ">
                {/* Ring 1 */}
                <div
                  className={`absolute z-[999] inset-0 rounded-full pulse-ring ${livelinessMessage === "Nice Smile!😉"
                ...
                {/* Ring 2 */}
                <div
                  className={`absolute inset-0 rounded-full pulse-ring-alt ${livelinessMessage === "Nice Smile!😉"
                    ? "ring-2 ring-blue-400"
                    : livelinessMessage === "Please smile."
                ...
                {/* Ring 3 */}
                <div
                  className={`absolute inset-0 rounded-full pulse-ring-slow ${livelinessMessage === "Nice Smile!😉"
              ...
              {/* Main face circle */}
              <div
                className={`flex items-center justify-center w-[400px] h-[400px] sm:w-80 sm:h-80 rounded-full overflow-hidden transition-all duration-300 ${livelinessMessage === "Nice Smile!😉"
              ...
              <div className="absolute flex justify-center translate-y-[190px] sm:translate-y-[140px] w-full ">
                <span
                  className={`px-4 py-2 backdrop-blur-sm rounded-full text-sm sm:text-xs font-medium transition-all ${livelinessStatus === "passed"
        ...
        <div className="relative grid grid-cols-3 justify-center w-full mt-20 px-4 gap-4">
          <div className="flex flex-col gap-2 justify-start max-w-60">
            ...
            <span
              className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium ${status === "Running"
          ...
          <div className="flex justify-center">
            ...
            >
              <RotateCcwIcon
                className={`w-5 h-5 text-white transition-transform duration-500 ${camera === "user" ? "rotate-180" : "rotate-0"
                  }`}
              />
            </button>
          </div>
