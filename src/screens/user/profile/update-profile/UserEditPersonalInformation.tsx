  ...
  return (
    <div className='flex flex-col w-full items-center p-8 bg-primary-foreground border border-border'>
      ...
      <div className="flex flex-col items-center mt-4">
        <p className="animate-pulse text-2xl text-primary truncate">
          I'm, {fullName}! 👋
        </p>
        <p className="text-sm italic text-foreground flex items-center">
          I am currently{" "}
          <span className={`mx-2 ${statusDetails.color}`}>
            <Badge className="animate-bounce">
              {convertStatus(parseInt(status))}
            </Badge>
          </span>
          {statusDetails.icon}
        </p>
      ...
      <div className="flex justify-center w-full">
        ...
        <Button className="mt-8 " onClick={() => setIsDialogOpen(true)}>
          Save Changes{" "}
          <span>
            <ArrowRight />
          </span>
        ...
        <DialogContent className="sm:w-[90%]">
          ...
          <DialogFooter>
            <div className="  flex gap-4 ">
              ...
              <Button className="text-foreground" onClick={handleConfirm}>
                Confirm
              </Button>
            </div>
          </DialogFooter>
      ...
      <Dialog
        ...
        onOpenChange={setIsProfilePhotoModalOpen}
      >
        <DialogContent>
          <DialogTitle className="text-foreground">
